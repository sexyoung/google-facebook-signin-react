...
var FacebookSSO = /** @class */ (function (_super) {
    ...
    FacebookSSO.prototype.render = function () {
        return (createElement("button", { disabled: this.props.isDisabled || this.state.isProgressing, onClick: this.loginFB, className: [this.props.className, "loginBtn loginBtn--facebook"].join(" ") }, this.props.children));
    };
...
var GoogleSSO = /** @class */ (function (_super) {
    ...
    GoogleSSO.prototype.render = function () {
        return (createElement("button", { className: [this.props.className, "loginBtn loginBtn--google"].join(" "), disabled: this.props.isDisabled || this.state.isProgressing, onClick: this.loginGoogle }, this.props.children));
    };
...
var GoogleSignIn = /** @class */ (function (_super) {
    ...
    GoogleSignIn.prototype.render = function () {
        return (createElement(GoogleSSO, { onResolve: this.props.onResolve, onReject: this.props.onReject, client_id: this.props.client_id, className: this.props.className, cookie_policy: this.props.cookie_policy, scope: this.props.scope, fetch_basic_profile: this.props.fetch_basic_profile, hosted_domain: this.props.hosted_domain, openid_realm: this.props.openid_realm, ux_mode: this.props.ux_mode, redirect_uri: this.props.redirect_uri, prompt: this.props.prompt, response_type: this.props.response_type, login_hint: this.props.login_hint, discoveryDocs: this.props.discoveryDocs, access_type: this.props.access_type, isDisabled: this.props.isDisabled }, this.props.children));
    };
